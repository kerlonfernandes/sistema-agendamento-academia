...
// Consulta os agendamentos para o horário selecionado
            ...
            <tbody>
                <?php foreach ($agendamentos->results as $agendamento): ?>
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-<?= 
                                $agendamento->status_agendamento == 'confirmado' ? 'success' : 
                                ($agendamento->status_agendamento == 'pendente' ? 'warning' : 'secondary') 
                            ?>">
